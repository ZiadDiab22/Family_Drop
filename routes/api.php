...
Route::group(["middleware" => ["auth:api"]], function () {
    ...
    Route::get("deleteProductRequest/{id}", [RequestController::class, "deleteProductRequest"])->middleware(AllowNonMarketers::class);
    ...
    Route::get("deletePullProductRequest/{id}", [RequestController::class, "deletePullProductRequest"])->middleware(AllowNonMarketers::class);
